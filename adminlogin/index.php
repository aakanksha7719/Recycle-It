...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background-color:#37517e'>
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost/pbl/index.html">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse"style="background: linear-gradient(60deg, rgb(143 218 245) 0%, rgb(149 233 250) 100%);">
            <ul class="nav navbar-nav side-nav"style="background: linear-gradient(60deg, rgba(84,58,183,1) 0%, rgba(84,58,183,1) 100%); ">
                <li>
                    <a href="http://localhost/pbl/adminlogin/index.html" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-search"></i><mark> Dashboard</mark> <i class="fa fa-fw fa-angle-down pull-right"></i></a>
...
function confirmDelete(){
    window.location.replace("http://localhost/pbl/adminlogin/admindelete.php?i="+delId);
}
</script>
</body>
</html>