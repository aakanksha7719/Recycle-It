...
<div id="wrapper">
   ...
   phpinfo();
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background: linear-gradient(60deg, rgba(84,58,183,1) 0%, rgb(153 244 255) 100%);'>
       ...
       <ul class="nav navbar-right top-nav">           
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" style='background: linear-gradient(60deg, rgb(146 227 248) 0%, rgb(149 233 250) 100%);float: right;'>
            <!--<ul class="nav navbar-nav side-nav">-->
                <li>
                    <a href="index.html" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-home"style="color: black" ></i><mark style="background: none;color: black;" >Home</mark> <!--<i class="fa fa-fw fa-angle-down pull-right"></i>--></a>
                </li>
                <!--<li>
                    <a href="new_form.php"><i class="fa fa-fw fa fa-plus-square" style="color: black    ;" ></i><span style="background: none;color: black;" >New aplication</span></a>
                </li>-->
                <li>
                    <a href="logout-user.php"><i class="fa fa-fw fa fa-sign-out" style="color: black;" ></i><span style="background: none;color: black;" >Logout</span></a>
                </li>
           <!-- </ul> -->
        </div>
        <!-- /.navbar-collapse -->
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <!-- Page Heading -->
            <div class="row" id="main" style="margin-top:  55px;margin-left: -150px;margin-right: 50px;" >
   ...
   $query = "select * from homewaste_info";
