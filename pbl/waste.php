  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" href="smtp/index.php">
            <a href="smtp/index.php" id="link_address" style="text-decoration: none;color: white;" >
                Yes
            </a>
        </button>
      </div>
       ...
       <ul class="nav navbar-right top-nav">           
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" style='background: linear-gradient(60deg, rgb(143 218 245) 0%, rgb(149 233 250) 100%);float: right;'>
            <ul class="nav navbar-nav side-nav" style="background: linear-gradient(60deg, rgba(84,58,183,1) 0%, rgba(84,58,183,1) 100%); ">
                <li>
                    <a href="http://localhost/pbl/index2.html" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-home"style="color: white;" ></i><mark style="background: none;color: white;" > Home</mark> <!--<i class="fa fa-fw fa-angle-down pull-right"></i>--></a>
                </li>
