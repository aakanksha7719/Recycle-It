...
#ch {
 ...
 overflow: hidden;
   ...
   <div class="sidebar">
  <img src="icon2.PNG" alt="LOGO"heigth='30'width='30'class='logo1' style="float:left; padding-top:8px; padding-right:2px;"><a href="http://localhost/pbl/index2.html"  class="fa fa-home"><strong> Home</strong></a>
 <a href="http://localhost/pbl/password-changed.php"  class="fa fa-key"><strong> Change Password -
 </strong></a>
  ...
  <a href="#about">About</a> -->
   ...
   <!-- <nav class="fixed-top">
    <a class="navbar-brand" href="http://localhost/pbl/index.html">Home</a>
    </nav>
    <br> -->
   ...
   if($total!=0) {
     ...
     echo "
           <tr class='shadow p-3 mb-5 bg-white rounded'>
               ...
               <td><a href = '../phpGmailSMTP/upload/".$result['file']. "'><img src = '../phpGmailSMTP/upload/".$result['file']. "' 'height='200'width='200'/></a> </td>   
               <td>   ".$result['status']." </td>            
...
function confirmDelete(){
    window.location.replace("http://localhost/pbl/adminlogin/delete.php?i="+delId);
}
</script>
</body>
</html>
